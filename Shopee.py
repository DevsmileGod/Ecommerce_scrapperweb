...
class Shopee:
    ...
    def _wait_full_render(self) -> None:
        ...
        try:  # Attempt waiting for render with error handling
            ...
            print(f"{BackgroundColors.YELLOW}Warning during render wait: {e}{Style.RESET_ALL}")  # Warn user about render wait issues without failingdef verbose_output(true_string="", false_string=""):
    """
