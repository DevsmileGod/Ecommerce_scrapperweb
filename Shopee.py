...
class Shopee:
    ...
    def create_product_description_file(self, product_data, output_dir, product_name_safe, url):
        ...
        try:  # Try to create the .txt file
            ...
            template_content = PRODUCT_DESCRIPTION_TEMPLATE.format(  # Format template with product data
                ...
                description=description,  # Sentence-cased product description
...
def main():
    ...
    print(  # Clear terminal and display welcome message
        f"{BackgroundColors.BOLD}{BackgroundColors.GREEN}Welcome to the {BackgroundColors.CYAN}Shopee Scraper{BackgroundColors.GREEN} program!{Style.RESET_ALL}",
        end="\n",  # End with newline
    )  # End of print statement
